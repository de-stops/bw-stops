...
This is a simple script to download all [BW](https://www.nvbw.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
